...
use Exception;
use Tokenly\XCallerReceiver\Exception\AuthorizationException;
...
class WebHookReceiver
{
     ...
     * Throws an AuthorizationException if validation fails
     * @param  \Symfony\Component\HttpFoundation\Request $request A Symfony request object
     * @return array notification
     */
     ...
     * Throws an AuthorizationException if validation fails
     * @param  array $json_data The incoming JSON data
